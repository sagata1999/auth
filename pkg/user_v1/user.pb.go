...
var file_user_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5f, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x49,
	...
	0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x1e, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x52, 0x6f,
	0x6c, 0x65, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0x9d, 0x01, 0x0a, 0x0a, 0x43, 0x72, 0x65,
	...
	0x6c, 0x65, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0xb0, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65,
	...
	0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x35, 0x0a, 0x0d, 0x43,
	...
	0x72, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73,
	...
	0x72, 0x22, 0xa5, 0x01, 0x0a, 0x0d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	0x61, 0x64, 0x6d, 0x69, 0x6e, 0x10, 0x01, 0x32, 0xac, 0x02, 0x0a, 0x06, 0x55, 0x73, 0x65, 0x72,
	0x56, 0x31, 0x12, 0x4f, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x13, 0x2e, 0x75,
	...
	0x3a, 0x01, 0x2a, 0x12, 0x3c, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x10, 0x2e, 0x75, 0x73, 0x65,
	...
	0x31, 0x12, 0x4a, 0x0a, 0x06, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x13, 0x2e, 0x75, 0x73,
	...
	0x32, 0x08, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x3a, 0x01, 0x2a, 0x12, 0x47, 0x0a,
	...
	0x73, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x42, 0x9d, 0x01, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x61, 0x67, 0x61, 0x74, 0x61, 0x31, 0x39, 0x39, 0x39,
	0x2f, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x76,
	0x31, 0x3b, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x76, 0x31, 0x92, 0x41, 0x6a, 0x12, 0x30, 0x0a, 0x08,
	0x55, 0x73, 0x65, 0x72, 0x20, 0x41, 0x50, 0x49, 0x22, 0x1d, 0x0a, 0x0e, 0x41, 0x7a, 0x61, 0x6d,
	0x61, 0x74, 0x20, 0x56, 0x61, 0x6c, 0x69, 0x74, 0x6f, 0x76, 0x1a, 0x0b, 0x6d, 0x79, 0x40, 0x6d,
...
var file_user_proto_depIdxs = []int32{
	...
	0,  // 1: user.CreateUser.role:type_name -> user.Role
	1,  // 2: user.User.info:type_name -> user.UserInfo
	10, // 3: user.User.created_at:type_name -> google.protobuf.Timestamp
	10, // 4: user.User.updated_at:type_name -> google.protobuf.Timestamp
	2,  // 5: user.CreateRequest.user:type_name -> user.CreateUser
	3,  // 6: user.GetResponse.user:type_name -> user.User
	11, // 7: user.UpdateRequest.name:type_name -> google.protobuf.StringValue
	11, // 8: user.UpdateRequest.email:type_name -> google.protobuf.StringValue
	0,  // 9: user.UpdateRequest.role:type_name -> user.Role
	4,  // 10: user.UserV1.Create:input_type -> user.CreateRequest
	6,  // 11: user.UserV1.Get:input_type -> user.GetRequest
	8,  // 12: user.UserV1.Update:input_type -> user.UpdateRequest
	9,  // 13: user.UserV1.Delete:input_type -> user.DeleteRequest
	5,  // 14: user.UserV1.Create:output_type -> user.CreateResponse
	7,  // 15: user.UserV1.Get:output_type -> user.GetResponse
	12, // 16: user.UserV1.Update:output_type -> google.protobuf.Empty
	12, // 17: user.UserV1.Delete:output_type -> google.protobuf.Empty
